...
export default function Historial() {
    ...
    // Detail panel
    const [selectedCapture, setSelectedCapture] = useState<Consumo | null>(null);
                                ...
                                data.map(c => {
                                    ...
                                    return (
                                        <TableRow
                                            ...
                                            onClick={isCapture ? () => setSelectedCapture(c) : undefined}
                                        >
